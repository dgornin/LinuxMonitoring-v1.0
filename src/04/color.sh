...
color_text () {
    local output='black'
    if [ $1 -eq 1 ]; then output='white'; fi
    if [ $1 -eq 2 ]; then output='red'; fi
    if [ $1 -eq 3 ]; then output='green'; fi
    if [ $1 -eq 4 ]; then output='blue'; fi
    if [ $1 -eq 5 ]; then output='purple'; fi
    if [ $1 -eq 6 ]; then output='black'; fi
    if [ $1 -eq -1 ]; then output='white'; fi
    if [ $1 -eq -2 ]; then output='red'; fi
    if [ $1 -eq -3 ]; then output='green'; fi
    if [ $1 -eq -4 ]; then output='blue'; fi
